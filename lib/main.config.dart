...
import 'domain/usecase/password/get_all_paswords_use_case.dart' as _i7;
import 'domain/usecase/password/save_password_use_case.dart' as _i6;
import 'presentation/page/password/create/bloc/password_create_bloc.dart'
    as _i9;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.GetAllPasswordsUseCase>(
      () => _i7.GetAllPasswordsUseCase(get<_i4.PasswordRepository>()));
  gh.factory<_i8.PasswordBloc>(
      () => _i8.PasswordBloc(get<_i7.GetAllPasswordsUseCase>()));
  gh.factory<_i9.PasswordCreateBloc>(
      () => _i9.PasswordCreateBloc(get<_i6.SavePasswordUsecase>()));
  return get;
}
